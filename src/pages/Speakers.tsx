      ...
      <section className="w-full bg-white py-24">
         <div className="max-w-[1200px] mx-auto px-6 pb-8">
           <FadeUp className="text-center mb-16">
             <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tighter text-[#1d1d1f]">Les grands débats.</h2>
           </FadeUp>
           <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <FadeUp delay={0.1} className="bg-[#f5f5f7] p-10 md:p-12 rounded-3xl group flex flex-col justify-between shadow-sm min-h-[350px]">
              ...
              <div>
                <h2 className="text-3xl lg:text-4xl font-bold tracking-tight mb-4 text-[#1d1d1f]">Environnement</h2>
            ...
            <FadeUp delay={0.2} className="bg-[#f5f5f7] p-10 md:p-12 rounded-3xl group flex flex-col justify-between shadow-sm min-h-[350px]">
              ...
              <div>
                <h2 className="text-3xl lg:text-4xl font-bold tracking-tight mb-4 text-[#1d1d1f]">Socio-économie</h2>
                <p className="text-[#86868b] text-lg font-medium leading-relaxed max-w-sm">
      ...
      <section className="w-full py-24 bg-[#f5f5f7]">
        <div className="max-w-[1200px] mx-auto px-6 text-center">
          <FadeUp className="mb-16">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tighter text-[#1d1d1f]">
              Les organisateurs.
            </h2>
