    ...
    <div className="w-full flex flex-col items-center bg-[#f5f5f7]">
      ...
      <section className="w-full py-24 px-6 bg-white">
        <FadeUp className="max-w-[1000px] mx-auto text-center">
          ...
          <h2 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tighter text-[#1d1d1f] mb-8">
            Créer sans coder.
          </h2>
      ...
      <section className="w-full py-16 md:py-24 px-4 sm:px-6">
        <div className="max-w-[1200px] mx-auto">
          <FadeUp className="text-center mb-16">
            <h2 className="text-4xl md:text-6xl font-bold tracking-tighter text-[#1d1d1f] mb-4">
              Un programme riche.
            </h2>
