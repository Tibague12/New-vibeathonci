  ...
  return (
    <div className="w-full flex flex-col items-center bg-white">
      ...
      <section className="w-full bg-[#f5f5f7] py-24">
        <div className="max-w-[1000px] mx-auto px-6">
          <FadeUp className="text-center mb-16">
             <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tighter text-[#1d1d1f]">Le concept.</h2>
          </FadeUp>
      ...
      <section className="w-full bg-white py-24">
        <div className="max-w-[1000px] mx-auto px-6">
          <FadeUp className="text-center mb-16">
             <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tighter text-[#1d1d1f]">Le déroulement.</h2>
          </FadeUp>
      ...
      <section className="w-full bg-[#f5f5f7] py-24">
        <div className="max-w-[1000px] mx-auto px-6">
          <FadeUp className="text-center mb-16">
             <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tighter text-[#1d1d1f]">Évaluation.</h2>
